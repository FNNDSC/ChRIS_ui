...
export default class TreeModel {
  ...
  private _parseTreeChildren(workingItems: PluginInstance[], _workingId: NodeId, _parentIndex = 0) {
  ...
  private _findChildrenNodes(id: NodeId, _parentIndex: number) {
    const workingChildrenArr = _.filter(this._workingItems, (subitem: PluginInstance) => {

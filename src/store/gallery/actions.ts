...
export const setGalleryItems = (data: {selectedFile: IUITreeNode; selectedFolder: IUITreeNode; }) => action(GalleryActionTypes.SET_GALLERY_ITEMS, data); // Set initial array

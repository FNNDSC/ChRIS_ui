          ...
          <Grid hasGutter>
            {data && !loading ? (
                  ...
                  runningJobsCount > 0 ? (
                    <>
                      ...
                      <b>
                        ...
                        {pluralize("job", runningJobsCount)}
                      </b>
                    </>
                  ) : (
                    <b>
                      Completed {finished_jobs}{" "}
                      {pluralize("job", finished_jobs)}
                    </b>
                  );
              ...
              <EmptyState>
                ...
                <EmptyStateBody>Fetching your Feeds</EmptyStateBody>
              </EmptyState>
            ) : (
              <EmptyState>
                ...
                <EmptyStateBody>
                  Create a Feed by clicking on the &apos;Create Feed&apos;
                  button
                </EmptyStateBody>
              </EmptyState>
            )}
...
function DeleteFeed({
  ...
  return (
    <>
      ...
      <Button variant="secondary" onClick={() => onTogglePopover("none")}>
        No
      </Button>
    </>
  );

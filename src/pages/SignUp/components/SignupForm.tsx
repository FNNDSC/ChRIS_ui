...
import { AiFillEyeInvisible, AiFillEye, AiFillExclamationCircle } from 'react-icons/ai'
...
const mapDispatchToProps = (dispatch: Dispatch) => ({
  setAuthToken: (auth: { token: string; username: string }) => dispatch(setAuthToken(auth)),
})

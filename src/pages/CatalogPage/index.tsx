        ...
        <InfoIcon
          ...
          p2={
            <Paragraph style={style}>
              ...
              DICOM images to a format like JPG and <i>Running a FreeSurfer</i>{' '}
              analysis on the medical DICOMs all in one <b>Workflow</b>. The{' '}
              <b>Pipelines</b> section catalogues the <b>Pipelines</b> available
              in this ChRIS. Note, you can add new <b>Pipelines</b> to this
              ...
              always available and is the actual server that is running ChRIS.

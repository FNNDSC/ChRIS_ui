...
const GalleryDicomView = ({ type }: { type: string }) => {
  ...
  const [galleryDicomState, setGalleryDicomState] = React.useState<GalleryState>(getInitialState())

  const { inPlay, visibleHeader, frameRate, frame, tools, activeTool, numberOfFrames } =
    galleryDicomState
                                  ...
                                  (eventData: CornerstoneEvent) => {
                                    if (eventData.detail) {
                                      ...
                                      if (viewport) {
                                        ...
                                        newViewport.voi.windowWidth = image && image.windowWidth
                                        newViewport.voi.windowCenter = image && image.windowCenter
                                        ...
                                        cornerstone.setViewport(cornerstoneElement, setViewport)
                                      }
                                    }
                                  }
                                )
